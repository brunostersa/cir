...
export default function GraficaCidade({ cidade, estado, cidadesProximas, content }) {
  ...
  return (
    <div className="cir-root">
      ...
      <div className="cp-trust-bar cir-reveal cir-reveal--d1">
        <div className="cp-trust-item">
          <span className="cp-trust-num">27</span>
          <span className="cp-trust-label">Anos de mercado</span>
        </div>
        <div className="cp-trust-item">
          <span className="cp-trust-num">+5k</span>
          <span className="cp-trust-label">Materiais revisados</span>
        </div>
        <div className="cp-trust-item">
          <span className="cp-trust-num">100%</span>
          <span className="cp-trust-label">Consultorias evitaram reimpressão</span>
        </div>
      </div>
      ...
      <div className="cp-cta">
        ...
        <div className="cp-cta-btns">
          <WhatsAppLink message={`Olá! Sou de ${cidade} e gostaria de um orçamento para meu projeto de gráfica.`} source="cta_final_cidade" cidade={cidade} estado={estado} className="btn-primary">
            WhatsApp Agora
          </WhatsAppLink>
          <WhatsAppLink message={`Olá! Sou de ${cidade} e gostaria de um orçamento para meu projeto de gráfica.`} source="cta_final_cidade_formulario" cidade={cidade} estado={estado} className="btn-secondary">
            Formulário Online
          </WhatsAppLink>
        </div>
      </div>
      ...
      <WhatsAppLink message={`Olá! Sou de ${cidade} e gostaria de mais informações sobre serviços de gráfica.`} source="fab_cidade" cidade={cidade} estado={estado} className="cir-wa-fab" aria-label="WhatsApp">
      ...
      <StickyMobileCTA cidade={cidade} estado={estado} />
      <LeadPopup cidade={cidade} estado={estado} />
    </div>
  );
}
